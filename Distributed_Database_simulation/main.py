...
def main():
    ...
    users_data = [
        ...
        {'id': 8, 'name': "Alice", 'email': "alice@example.com"},  # Will fail: duplicate email
        {'id': 9, 'name': "Henry", 'email': "henry@example.com"},
        {'id': 10, 'name': "", 'email': "jane@example.com"}      # Will fail: empty name
    ]
    ...
    products_data = [
        ...
        {'id': 7, 'name': "Laptop", 'price': 1200.00},  # Will fail: duplicate product name
        {'id': 8, 'name': "Smartwatch", 'price': 250.00},
        {'id': 9, 'name': "Gaming Chair", 'price': 500.00},
        {'id': 10, 'name': "Earbuds", 'price': -50.00}  # Will fail: negative price
    ]
    ...
    orders_data = [
        ...
        {'id': 8, 'user_id': 8, 'product_id': 8, 'quantity': 0},    # Will fail: quantity 0
        {'id': 9, 'user_id': 9, 'product_id': 1, 'quantity': -1},   # Will fail: negative quantity
        {'id': 10, 'user_id': 10, 'product_id': 11, 'quantity': 2}  # Will fail: invalid product_id
    ]
